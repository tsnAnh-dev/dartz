...
abstract mixin class ApplicativePlus<F> implements Applicative<F>, PlusEmpty<F> {
  F prependElement<A>(F fa, A a) => plus(pure(a), fa);
  F appendElement<A>(F fa, A a) => plus(fa, pure(a));
}

abstract mixin class ApplicativePlusOps<F, A> implements ApplicativeOps<F, A>, PlusEmptyOps<F, A> {
